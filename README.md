...
- CSV files appear in `data/` (e.g., `META_20251018T180020Z.csv`)
...
**Why:** UTC timestamps ensure reproducibility and sortability. Each run creates a unique file, enabling version control and comparison of plots over time. ([Jupyter best practices](https://jupyter.org/practices))
...
![FAANG Close Price Plot](plots/faang_close_20251021T183203Z.png)
...
- A timestamped PNG file appears in `plots/` (e.g., `faang_close_20251021T183203Z.png`)
